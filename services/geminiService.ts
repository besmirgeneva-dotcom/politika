...
5. FORMAT: Réponds UNIQUEMENT via le schéma JSON minifié fourni.
`;
...
export const simulateTurn = async (
  ...
  const prompt = `
    DATE:${currentDate}|PAYS:${playerCountry}(Mil:${playerPower})|POSS:${ownedTerritories.join(',')}|CHAOS:${chaosLevel}|${allContext}
